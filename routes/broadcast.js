...
router.get('/', requireAuth, async (req, res) => {
  ...
  res.send('<!DOCTYPE html><html lang="ja"><head><meta charset="UTF-8">'
    ...
    + '</div>'
    + '<div class="drop-zone" data-file-input="broadcastFile" data-target-textarea="broadcastMsgJa" style="margin-bottom:12px;border:2px dashed #ccc;border-radius:6px;padding:12px;">'
