...
setInterval(checkNewMessages, 30000);
  ...
  res.send('<!DOCTYPE html><html lang="ja"><head><meta charset="UTF-8">'
    ...
    + '</form>'
    + '<table><colgroup>'
    + '<col style="width:9%;"><col style="width:14%;"><col style="width:10%;"><col style="width:8%;">'
    + '<col style="width:20%;"><col style="width:20%;"><col style="width:8%;"><col style="width:6%;"><col style="width:5%;">'
    + '</colgroup><thead><tr>'
